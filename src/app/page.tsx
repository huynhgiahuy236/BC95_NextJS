import RoomPage from "@/app/auth/rooms/page";
import Image from "next/image";
import Link from "next/link";

// mặc định phải truyền đúng đường dẫn tới page.tsx của route
// vd: auth/login/page.tsx => "auth/login"
// muon bỏ auth => bỏ auth trong ngoặc (auth)
export default function Home() {
  return (
    <div className="flex flex-col flex-1 items-center justify-center bg-zinc-50 font-sans ">
      ...
      <div className="">
        <h1 className="text-center py-10 text-2xl font-medium text-blue-700">
          BC95 Hotel
        </h1>
